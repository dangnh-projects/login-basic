defmodule LoginBasicWeb.Pow.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug LoginBasicWeb.EnsureRolePlug, [:user, :admin]

      plug LoginBasicWeb.EnsureRolePlug, :admin

      plug LoginBasicWeb.EnsureRolePlug, ~w(user admin)a
  """
